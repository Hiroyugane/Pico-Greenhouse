...
#
# AlwaysOnFanController — constant duty (Pico case fan), the one fan
# policy outside the RegulationEngine pipeline. The thermostat_schedule
# and heater_follower policies that used to live alongside it were
# superseded by the engine's surface/follower regulators. Consumes a
# FanOutput so it works over relays and PCA9685 PWM channels alike.
